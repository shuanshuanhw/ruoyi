...
insert into sys_dept values(112,  100, '0,100',      '技术分管', 2, '冯清首', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);

insert into sys_dept values(103,  101, '0,100,101',  '少儿服务部',   1, '梁惠群', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(104,  101, '0,100,101',  '书刊借阅部',   2, '欧阳长弟', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '数字资源服务部',   3, '陈振聪', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(106,  101, '0,100,101',  '办公室',   4, '戴莹娜', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(107,  102, '0,100,101',  '采编部',   5, '吴曼菊', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(108,  102, '0,100,102',  '基层服务部',   1, '谭伟恒', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(109,  102, '0,100,102',  '地方文献部',   2, '张宇', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);

insert into sys_dept values(110,  112, '0,100,102',  '技术部',   2, '杨建文', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(111,  112, '0,100,102',  '信息开发部',   2, '胡应文', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
